...
var HTMLprojectImage = '<img class = "project-image" src="%data%" alt="A picture representing Mikes project">';
...
var HTMLonlineClassStart = '<br><div class="online-entry"><h3 class="no-padding">Online Classes</h3></div>'
